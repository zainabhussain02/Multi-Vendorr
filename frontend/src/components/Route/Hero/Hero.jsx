    ...
    >
        <div className={`${styles.section} w-[90%] 800px:w-[60%]`}>
            ...
            <p className='pt-5 text-[16px] font-[Poppins] font-[400] text-[#000000ba]' >
                ...
                , dolore necessitatibus nesciunt ea 
                expedita hic numquam? Eum obcaecati
                 corporis quibusdam, odit veniam 
                 accusantium quidem explicabo 
                 voluptatum! Pariatur, reiciendis consectetur.
            </p>
